...
Kirigami.ApplicationWindow {
    ...
    // The exact syntax for making a custom property in QML is:
    // property <type> <name>: <default_value>
    // We are using this because there was scoping issues with the color change
